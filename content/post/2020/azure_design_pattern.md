+++
author = "Binwei Wu"
title = "Azure Design Pattern"
date = "2020-05-01"
description = "Azure Design Pattern"
featured = true
tags = [
    "cloud", "architecture"
]
...
- [Data Management and Performance](#data-management-and-performance)
  ...
  - [Static Content Hosting Pattern](#static-content-hosting-pattern)
  - [The Cache-aside Pattern](#the-cache-aside-pattern)
  - [CQRS pattern](#cqrs-pattern)
- [Availability and resilience](#availability-and-resilience)
  - [Circuit Breaker Pattern](#circuit-breaker-pattern)
  - [Compensating Transaction Pattern](#compensating-transaction-pattern)
  - [Health Endpoint Monitoring Pattern](#health-endpoint-monitoring-pattern)
  - [Queue-based load levelling pattern](#queue-based-load-levelling-pattern)
  - [Retry pattern](#retry-pattern)
  - [Throttling Pattern](#throttling-pattern)
- [Design and Implementation](#design-and-implementation)
  - [External Configuration Store Pattern](#external-configuration-store-pattern)
  - [Federated Identity Pattern](#federated-identity-pattern)
  - [Gatekeeper Pattern](#gatekeeper-pattern)
  - [Runtime Reconfiguration Pattern](#runtime-reconfiguration-pattern)
  - [Valet Key Pattern](#valet-key-pattern)
- [Resources](#resources)
...
![Static Content Hosting Pattern](images/static_content_hosting_pattern.png)
...
![The Cache-aside Pattern](images/the_cache_aside_pattern.png)
...
![Problems with Mixing Reads and Writes](images/problems_with_mixing_reads_and_writes.png)

CQRS pattern looks like following:

![Event Sourcing and CQRS](images/event_sourcing_and_cqrs.png)
...
![Circuit Breaker Pattern](images/circuit_breaker_pattern.png)
...
![Compensating Transaction Pattern](images/compensating_transaction_pattern.png)
...
![Health Endpoint Monitoring Pattern](images/health_endpoint_monitoring_pattern.png)
...
![Throttling Pattern](images/throttling_pattern.png)
...
![Gatekeeper Pattern](images/gatekeeper_pattern.png)
...
![Valet Key Pattern](images/valet_key_pattern.png)

![Valet Key Pattern Demo](images/valet_key_pattern_demo.png)
