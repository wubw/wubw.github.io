+++
author = "Binwei Wu"
title = "Git: Branch Continue"
date = "2017-01-30"
description = "Git: Branch Continue"
featured = true
tags = [
    "git"
]
...
In order to use git branch in a correct way, you need to understand the good practice of using git flow. There is a good blog explains the [git flow ](http://nvie.com/posts/a-successful-git-branching-model/).
