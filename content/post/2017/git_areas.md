...
It is not easy to remember all the commands and arguments. Just remember the basic and visit [git doc ](https://git-scm.com/doc/) when necessary will help.
